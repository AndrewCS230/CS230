...
<main>
    ...
    <div class="container" align="center" style="max-width: 800 px;">
        <div class="my-auto">
            <form id="review-form" action="includes/review-helper.php"></form>

            <div class="container">
                <i class="fa fa-shopping-bag fa-2x star-rev" data-index="1"></i>
                <i class="fa fa-shopping-bag fa-2x star-rev" data-index="2"></i>
                <i class="fa fa-shopping-bag fa-2x star-rev" data-index="3"></i>
                <i class="fa fa-shopping-bag fa-2x star-rev" data-index="4"></i>
                <i class="fa fa-shopping-bag fa-2x star-rev" data-index="5"></i>
            </div>
            ...
            <div class="form-group">
                <button class="btn btn-outline-success" type="submit" name="id-submit" id="review-submit"
